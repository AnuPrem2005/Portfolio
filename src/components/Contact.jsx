...
const Contact = () => {
  ...
  return (
    <div id='contact' className='bg-gray-50 w-full pt-20 pb-20'>
      ...
      <div data-aos="fade-right" className='bg-white p-5 rounded-xl shadow-xl w-120 h-140 hover:shadow-xl/20 hover:-translate-y-4 delay-150 duration-300 overflow-hidden boxxx'>
        ...
        <div className='mt-5 flex gap-5'>
          <a href="https://github.com/AnuPrem2005">
            <div className='rounded-xl grid place-content-center bg-black w-13 h-13 hover:-translate-y-1 delay-150 duration-300 hover:scale-110'>
              <FaGithub className='text-white text-4xl' />
            </div>
          </a>

          <a href="https://www.linkedin.com/in/anu-prem">
            <div className='rounded-xl grid place-content-center bg-black w-13 h-13 hover:-translate-y-1 delay-150 duration-300 hover:scale-110 hover:bg-blue-500'>
          ...
          <a href="https://www.instagram.com/sucesful_loser">
            <div className='rounded-xl grid place-content-center bg-black w-13 h-13 hover:-translate-y-1 delay-150 duration-300 hover:scale-110 hover:bg-red-500'>
      ...
      {/* CONTACT FORM */}
      <div data-aos="fade-left" className='bg-white p-5 rounded-xl shadow-xl w-120 h-140 hover:shadow-xl/20 hover:-translate-y-4 delay-150 duration-300 overflow-hidden boxxx'>
        <h2 className='text-xl font-bold text-gray-800 flex place-content-start mt-5'>
          Send Message
        </h2>
        ...
        <div className='mt-5 flex gap-5'>
          <div>
            ...
            <input
              type="text"
              className='input-half mt-2 w-50 h-10 pl-2 border border-gray-400 rounded-md focus:border-2 focus:outline-none focus:border-cyan-500'
        ...
        <div className='mt-3'>
          ...
          <input
            type="text"
            className='input-full mt-2 w-105 h-10 pl-2 border border-gray-400 rounded-md focus:border-2 focus:outline-none focus:border-cyan-500'
        ...
        <div className='mt-3'>
          <p>Message *</p>
          <textarea
            className='input-full mt-2 w-105 h-40 pl-2 pt-3 border border-gray-400 rounded-md focus:border-2 focus:outline-none focus:border-cyan-500'
        ...
        <div className='flex justify-center'>
          <button className='input-full flex place-items-center justify-center rounded-md gap-2 text-sm mt-3 bg-cyan-500 text-white font-bold p-3 w-105 hover:-translate-y-1 delay-150 duration-300 hover:bg-cyan-600'>
            <FiSend /> Send Message
          </button>
        </div>
      </div>
